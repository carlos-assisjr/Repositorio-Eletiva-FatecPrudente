...
<head>
    ...
    <title>calcular a velocidade média</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>

<body>
    <div class="container py-3">
        <h1>calcular a velocidade média</h1>
        <form method="post" action="exerc20_velo_media.php">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="tempo" class="form-label">tempo gasto (h)</label>
